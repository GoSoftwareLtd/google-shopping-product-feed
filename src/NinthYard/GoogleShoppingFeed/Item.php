...
class Item
{
	 ...
	 * @return [type]        [description]
	 */
	public function price($price, $currency = false)
	{
		$node = new Node('price');
		...
		$price = $node->value($price)->_namespace($this->namespace);
		$this->nodes['price'] = $price;
	}
	...
	public function shipping($code, $service, $cost)
	{
		...
		$value .= "<g:service>{$service}</g:service><g:price>{$cost}</g:price>";
	...
	public function custom_label_0($custom_label_0)
	{
		...
		$custom_label_0 = $this->safeCharEncodeText($custom_label_0);
	...
	public function custom_label_1($custom_label_1)
	{
		...
		$custom_label_1 = $this->safeCharEncodeText($custom_label_1);
	...
	public function custom_label_2($custom_label_2)
	{
		...
		$custom_label_2 = $this->safeCharEncodeText($custom_label_2);
	 ...
	 * @return [type]        [description]
	 */
	public function identifier_exists($identifier_exists = true)
	{
		$node = new Node('identifier_exists');
		$identifier_exists = ($identifier_exists === true)?'TRUE':'FALSE';
